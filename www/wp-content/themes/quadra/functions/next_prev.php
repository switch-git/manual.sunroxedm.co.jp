...
function next_prev_post_link2() {
  ...
  if ($prev_post) {
    ...
    $interview_data = get_post_meta($post_id, 'interview_data', true);
?>
<div class="item prev_post clearfix">
 <a class="animate_background" href="<?php echo get_permalink($post_id); ?>">
  ...
  <div class="title_area">
   <p class="title">
    <span class="name"><?php the_title_attribute('post='.$post_id); ?></span>
    <?php if($interview_data){ ?><span class="data"><?php echo esc_html($interview_data); ?></span><?php }; ?>
   </p>
  </div>
 </a>
</div>
