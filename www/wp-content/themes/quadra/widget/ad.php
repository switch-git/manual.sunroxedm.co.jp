...
class tcd_ad_widget extends WP_Widget {
  ...
  function widget($args, $instance) {
    ...
    echo $before_widget;
      ...
      if($random==0){
        if ($banner_code1) { echo $banner_code1; } else { echo '<a href="' . esc_url($banner_url1) . '" target="_blank" rel="nofollow noopener"><img src="' . esc_attr($banner_image1[0]) . '" alt="" /></a>' . "\n"; };
      } elseif($random==1){
        if ($banner_code2) { echo $banner_code2; } else { echo '<a href="' . esc_url($banner_url2) . '" target="_blank" rel="nofollow noopener"><img src="' . esc_attr($banner_image2[0]) . '" alt="" /></a>' . "\n"; };
      } elseif($random==2){
        if ($banner_code3) { echo $banner_code3; } else { echo '<a href="' . esc_url($banner_url3) . '" target="_blank" rel="nofollow noopener"><img src="' . esc_attr($banner_image3[0]) . '" alt="" /></a>' . "\n"; };
      };
...
<div class="tcd_ad_widget_box">
  <div class="tcd_widget_content">
   <h3 class="tcd_widget_headline"><?php _e('Register by HTML', 'tcd-w'); ?></h3>
  ...
  <div class="tcd_widget_content">
   <h3 class="tcd_widget_headline"><?php _e('Register image', 'tcd-w'); ?></h3>
  ...
  <div class="tcd_widget_content">
   <h3 class="tcd_widget_headline"><?php _e('Link url for registered image', 'tcd-w'); ?></h3>
