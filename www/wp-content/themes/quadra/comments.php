...
<div id="comments">
  ...
  <h2 class="headline rich_font"><span><?php _e('Comment', 'tcd-w'); ?></span></h2>

  <div id="comment_header" class="clearfix">
   <ul id="comment_tab" class="clearfix">
    <?php if ($options['single_post_show_comment']){ ?><li class="active"><a href="#commentlist_wrap"><?php comments_number( '0','1','%' ); ?> <?php _e( 'Comments', 'tcd-w' ); ?></a></li><?php }; ?>
    <?php if ($options['single_post_show_trackback']){ ?><li<?php if (!$options['single_post_show_comment']){ echo ' class="active"'; }; ?>><a href="#pinglist_wrap"><?php echo count($wp_query->comments_by_type['pings']); ?> <?php _e( 'Trackbacks', 'tcd-w' ); ?></a></li><?php }; ?>
   </ul>
  </div>
  ...
  <?php global $wp_query; ?>
   ...
   <?php
        ...
        if ($options['single_post_show_comment']) {
   ...
   <?php
        ...
        if ($options['single_post_show_trackback']) {
          if ( !empty ( $comments_by_type['pings'] )) {
   ?>
   <div id="pinglist_wrap" class="tab_contents" <?php if($options['single_post_show_comment']) { echo 'style="display:none;"'; }; ?>>
  ...
  <?php if ( comments_open() && $options['single_post_show_comment']) { ?>
