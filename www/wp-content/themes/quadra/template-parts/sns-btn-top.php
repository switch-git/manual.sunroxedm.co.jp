...
?>
<div class="share-<?php echo esc_attr( $options['sns_type_top'] ); ?> share-top">
<?php
// Type5
if ( $options['sns_type_top'] === 'type5' ) :
?>
	<div class="sns_default_top">
		<ul class="clearfix">
<?php
		if ( $options['show_twitter_top'] ) :
?>
...
?>
	<div class="sns">
		<ul class="<?php echo esc_attr( $options['sns_type_top'] ); ?> clearfix">
<?php
		if ( $options['show_twitter_top'] ) :
?>
			<li class="twitter">
				<a href="https://twitter.com/intent/tweet?text=<?php echo $title_encode ?>&url=<?php echo $url_encode ?>&via=<?php echo $options['twitter_info']; ?>&tw_p=tweetbutton&related=<?php echo $options['twitter_info']; ?>"><i class="icon-twitter"></i><span class="ttl">Post</span><span class="share-count"><?php if(function_exists('scc_get_share_twitter')) echo (scc_get_share_twitter()==0)?'':scc_get_share_twitter(); ?></span></a>
			</li>
<?php
		endif;
		if ( $options['show_fbshare_top'] ) :
...
?>
				<li class="pinterest">
					<a rel="nofollow" target="_blank" href="https://www.pinterest.com/pin/create/button/?url=<?php echo $url_encode ?>&media=<?php og_image(0) ?>&description=<?php echo $title_encode ?>" data-pin-do="buttonPin" data-pin-custom="true"><i class="icon-pinterest"></i><span class="ttl">Pin&nbsp;it</span></a>
				</li>
<?php
			endif;
		endif;
