...
function add_front_page_dp_default_options( $dp_default_options ) {
  ...
  $dp_default_options['index_slider_time'] = '5000';
  ...
  // フロントカバー
  $dp_default_options['index_header_type1_logo'] = false;
  $dp_default_options['index_header_type1_logo_retina'] = '';
  $dp_default_options['index_header_type1_catch'] = __( 'Catchphrase', 'tcd-w' );
  $dp_default_options['index_header_type1_desc'] = __( 'Description will be displayed here.<br>Description will be displayed here.', 'tcd-w' );
	$dp_default_options['index_header_type1_bg_color'] = '#000000';
  $dp_default_options['index_header_type1_bg_color_use_sub'] = 1;
	$dp_default_options['index_header_type1_bg_opacity'] = '0.7';

  $dp_default_options['index_header_type1_bg_image'] = false;
  $dp_default_options['index_header_type1_bg_image_mobile'] = false;
  $dp_default_options['index_header_type1_use_search_form'] = 1;
  $dp_default_options['index_header_type1_search_form_bg_color'] = '#000000';
  $dp_default_options['index_header_type1_search_form_bg_color_use_main'] = 1;
  $dp_default_options['index_header_type1_search_form_bg_opacity'] = '0.4';

  // 記事スライダー
  $dp_default_options['index_header_type2_post_type'] = 'recent_post';
	$dp_default_options['index_header_type2_post_order'] = 'date';
	$dp_default_options['index_header_type2_post_num'] = '3';
  $dp_default_options['index_header_type2_title_font_type'] = 'type2';
	$dp_default_options['index_header_type2_title_font_size'] = '36';
	$dp_default_options['index_header_type2_title_font_size_mobile'] = '22';
  $dp_default_options['index_header_type2_show_date'] = 1;
	$dp_default_options['index_header_type2_show_category'] = 1;
  ...
  // ボックスコンテンツ
  $dp_default_options['show_index_box_content'] = 1;
  $dp_default_options['index_box_content_font_size'] = '28';
  for ( $i = 1; $i <= 2; $i++ ) {
    $dp_default_options['index_box_content_headline'.$i] = __( 'Catchphrase', 'tcd-w' );
    ...
    $dp_default_options['index_box_content_icon_type'.$i] = 'type2';
    $dp_default_options['index_box_content_icon_size'.$i] = '26';
    $dp_default_options['index_box_content_icon_color'.$i] = '#FFFFFF';
    $dp_default_options['index_box_content_image'.$i] = false;
    $dp_default_options['index_box_content_image_retina'.$i] = false;
    $dp_default_options['index_box_content_url'.$i] = '#';
	}
  $dp_default_options['index_box_content_icon1'] = 'pencil';
  $dp_default_options['index_box_content_icon2'] = 'book';

  // ニュースティッカー
	$dp_default_options['show_index_news'] = 1;
	$dp_default_options['index_news_post_type'] = 'news';
	$dp_default_options['index_news_post_order'] = 'date';
  $dp_default_options['index_news_label'] = __( 'News list', 'tcd-w' );

  // コンテンツビルダー
	$dp_default_options['index_content_type'] = 'type1';

	$sample_cats = ['','cat1','cat2','cat3'];
  for ($i = 1; $i <= 3; $i++) {
    $cat_id = get_category_by_slug('category'.$i);
    if($cat_id){
	    $cat_id = $cat_id->cat_ID;
	    $sample_cats[$i] = 'category'.$cat_id;
	  }
  }

	$sample_tags = ['','tag1','tag2','tag3','tag4','tag5'];
	for ($i = 1; $i <= 5; $i++) {
	  $tag_id = get_term_by('slug', 'tag'.$i, 'post_tag');
	  if( $tag_id ){
	    $tag_id = $tag_id->term_id;
	    $sample_tags[$i] = 'tag'.$tag_id;
	  }
	}

	$dp_default_options['contents_builder'] = array(
		array(
			"cb_content_select" => "category_list",
			"show_content" => 1,
    ...
    array(
			"cb_content_select" => "blog_carousel",
			"show_content" => 1,
    ...
    array(
      ...
      $sample_tags[5] => 1,
			"title_font_size" => "12",
			"title_font_size_mobile" => "12",
      "bg_color" => "#000000",
      "bg_color_use_sub" => 1,
      "hover_bg_color" => "#444444",
      "hover_bg_color_use_main" => 1,
		),
		array(
			"cb_content_select" => "column_content",
			"show_content" => 1,
      "content_bg_color" => '#F4F4F4',
			"catch" => __( 'Catchphrase', 'tcd-w' ),
			"desc" => '',
			"item_list" => array(
			    array(
			        ...
			        "desc" => __( 'Description will be displayed here. Description will be displayed here.', 'tcd-w' ),
              "url" => "#",
			        "image" => ""
			    ),
			    array(
...
function add_front_page_tab_panel( $options ) {
  ...
  global $dp_default_options, $item_type_options, $time_options, $font_type_options, $box_content_icon_options;
...
<div id="tab-content-front-page" class="tab-content">
   ...
   <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <div id="show_index_slider" style="<?php if($options['show_index_slider'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">


     <!-- スライダーのラジオボタン -->
     <h4 class="theme_option_headline2"><?php _e('Content type', 'tcd-w');  ?></h4>
     <ul class="slider_type_radio_button cf">
      <li class="index_slider_type1_button <?php if($options['index_slider_type'] == 'type1'){ echo 'active'; }; ?>">
      ...
      <li class="index_slider_type2_button <?php if($options['index_slider_type'] == 'type2'){ echo 'active'; }; ?>">
      ...
      <li class="index_slider_type3_button <?php if($options['index_slider_type'] == 'type3'){ echo 'active'; }; ?>">
       <label for="index_slider_type3">
        <img src="<?php bloginfo('template_url'); ?>/admin/img/header_slider_type3.jpg" title="" alt="" />
        <span><?php _e('Content slider', 'tcd-w'); ?></span>
        <input type="radio" id="index_slider_type3" name="dp_options[index_slider_type]" value="type3" <?php checked( $options['index_slider_type'], 'type3' ); ?> />
       </label>
      </li>
     </ul>
     ...
     <div class="index_slider_type1_option" style="<?php if($options['index_slider_type'] == 'type1') { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
      ...
      <div class="sub_box cf">
        ...
        <div class="sub_box_content">
          ...
          <div class="image_box cf">
	          <div class="cf cf_media_field hide-if-no-js index_header_type1_logo">
		          <input type="hidden" value="<?php if($options['index_header_type1_logo']) { echo esc_attr( $options['index_header_type1_logo'] ); }; ?>" id="index_header_type1_logo" name="dp_options[index_header_type1_logo]" class="cf_media_id">
		          <div class="preview_field"><?php if($options['index_header_type1_logo']){ echo wp_get_attachment_image($options['index_header_type1_logo'], 'medium'); }; ?></div>
		          <div class="buttton_area">
		            <input type="button" value="<?php _e('Select Image', 'tcd-w'); ?>" class="cfmf-select-img button">
		            <input type="button" value="<?php _e('Remove Image', 'tcd-w'); ?>" class="cfmf-delete-img button <?php if(!$options['index_header_type1_logo']){ echo 'hidden'; }; ?>">
		          </div>
	          </div>
          </div>
          <p><label><input name="dp_options[index_header_type1_logo_retina]" type="checkbox" value="1" <?php checked( '1', $options['index_header_type1_logo_retina'] ); ?> /> <?php _e('Use retina display logo image', 'tcd-w');  ?></label></p>

          <h4 class="theme_option_headline2"><?php _e('Catchphrase', 'tcd-w');  ?></h4>
          <input class="full_width" type="text" name="dp_options[index_header_type1_catch]" value="<?php echo esc_attr($options['index_header_type1_catch']); ?>" />

          <h4 class="theme_option_headline2"><?php _e('Description', 'tcd-w');  ?></h4>
          <textarea class="full_width" cols="50" rows="2" name="dp_options[index_header_type1_desc]"><?php echo esc_textarea(  $options['index_header_type1_desc'] ); ?></textarea>
          ...
          <ul class="option_list">
            <li class="cf"><span class="label"><?php _e('Color of overlay', 'tcd-w'); ?></span>
              <div class="use_main_color">
                <input type="text" name="dp_options[index_header_type1_bg_color]" value="<?php echo esc_attr( $options['index_header_type1_bg_color'] ); ?>" data-default-color="#000000" class="c-color-picker">
              </div>
              <div class="use_main_color_checkbox">
                <label>
                  <input name="dp_options[index_header_type1_bg_color_use_sub]" type="checkbox" value="1" <?php checked( $options['index_header_type1_bg_color_use_sub'], 1 ); ?>>
                  <span><?php _e('Apply key color2', 'tcd-w'); ?></span>
                </label>
              </div>
            </li>
            <li class="cf">
              <span class="label"><?php _e('Transparency of overlay', 'tcd-w'); ?></span><input class="hankaku" style="width:70px;" type="number" max="1" min="0" step="0.1" name="dp_options[index_header_type1_bg_opacity]" value="<?php echo esc_attr( $options['index_header_type1_bg_opacity'] ); ?>" />
      ...
      <div class="sub_box cf">
        ...
        <div class="sub_box_content">
          ...
          <div class="image_box cf">
            <div class="cf cf_media_field hide-if-no-js index_header_type1_bg_image">
              <input type="hidden" value="<?php if($options['index_header_type1_bg_image']) { echo esc_attr( $options['index_header_type1_bg_image'] ); }; ?>" id="index_header_type1_bg_image" name="dp_options[index_header_type1_bg_image]" class="cf_media_id">
              <div class="preview_field"><?php if($options['index_header_type1_bg_image']){ echo wp_get_attachment_image($options['index_header_type1_bg_image'], 'medium'); }; ?></div>
              <div class="buttton_area">
                <input type="button" value="<?php _e('Select Image', 'tcd-w'); ?>" class="cfmf-select-img button">
                <input type="button" value="<?php _e('Remove Image', 'tcd-w'); ?>" class="cfmf-delete-img button <?php if(!$options['index_header_type1_bg_image']){ echo 'hidden'; }; ?>">
              </div>
            </div>
          </div>
          ...
          <div class="image_box cf">
            <div class="cf cf_media_field hide-if-no-js index_header_type1_bg_image_mobile">
              <input type="hidden" value="<?php if($options['index_header_type1_bg_image_mobile']) { echo esc_attr( $options['index_header_type1_bg_image_mobile'] ); }; ?>" id="index_header_type1_bg_image_mobile" name="dp_options[index_header_type1_bg_image_mobile]" class="cf_media_id">
              <div class="preview_field"><?php if($options['index_header_type1_bg_image_mobile']){ echo wp_get_attachment_image($options['index_header_type1_bg_image_mobile'], 'medium'); }; ?></div>
              <div class="buttton_area">
                <input type="button" value="<?php _e('Select Image', 'tcd-w'); ?>" class="cfmf-select-img button">
                <input type="button" value="<?php _e('Remove Image', 'tcd-w'); ?>" class="cfmf-delete-img button <?php if(!$options['index_header_type1_bg_image_mobile']){ echo 'hidden'; }; ?>">
              </div>
            </div>
          </div>

          <h4 class="theme_option_headline2"><?php _e('Search form setting', 'tcd-w');  ?></h4>
          <p class="displayment_checkbox"><label><input name="dp_options[index_header_type1_use_search_form]" type="checkbox" value="1" <?php checked( $options['index_header_type1_use_search_form'], 1 ); ?>><?php _e( 'Display the search form', 'tcd-w' ); ?></label></p>
          <div style="<?php if($options['index_header_type1_use_search_form'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">

            <ul class="option_list">
              <li class="cf" style="padding-top:8px; border-top:1px dotted #ddd;">
                <span class="label"><?php _e('Background color', 'tcd-w'); ?></span>
                <div class="use_main_color">
                  <input type="text" name="dp_options[index_header_type1_search_form_bg_color]" value="<?php echo esc_attr( $options['index_header_type1_search_form_bg_color'] ); ?>" data-default-color="#000000" class="c-color-picker">
                </div>
                <div class="use_main_color_checkbox">
                  <label>
                    <input name="dp_options[index_header_type1_search_form_bg_color_use_main]" type="checkbox" value="1" <?php checked( $options['index_header_type1_search_form_bg_color_use_main'], 1 ); ?>>
                    <span><?php _e('Apply key color1', 'tcd-w'); ?></span>
                  </label>
                </div>
              </li>
              <li class="cf">
                <span class="label"><?php _e('Transparency of background color', 'tcd-w'); ?></span><input class="hankaku" style="width:70px;" type="number" max="1" min="0" step="0.1" name="dp_options[index_header_type1_search_form_bg_opacity]" value="<?php echo esc_attr( $options['index_header_type1_search_form_bg_opacity'] ); ?>" />
                <div class="theme_option_message2" style="clear:both; margin:7px 0 0 0;">
                  <p><?php _e('Please specify the number of 0 from 1. Overlay color will be more transparent as the number is small.', 'tcd-w');  ?></p>
                </div>
              </li>
     ...
     <div class="index_slider_type2_option" style="<?php if($options['index_slider_type'] == 'type2') { echo 'display:block;'; } else { echo 'display:none;'; }; ?> margin-bottom: -10px;">
      ...
      <div class="sub_box cf">
          ...
          <div class="sub_box_content">
            ...
            <li class="cf"><span class="label"><?php _e('Post type', 'tcd-w'); ?></span>
              <select class="index_tab_post_list_type" name="dp_options[index_header_type2_post_type]">
              <option style="padding-right: 10px;" value="recent_post" <?php selected( $options['index_header_type2_post_type'], 'recent_post' ); ?>><?php _e('All post', 'tcd-w'); ?></option>
              <option style="padding-right: 10px;" value="recommend_post" <?php selected( $options['index_header_type2_post_type'], 'recommend_post' ); ?>><?php _e('Recommend post1', 'tcd-w'); ?></option>
              <option style="padding-right: 10px;" value="recommend_post2" <?php selected( $options['index_header_type2_post_type'], 'recommend_post2' ); ?>><?php _e('Recommend post2', 'tcd-w'); ?></option>
              </select>
            </li>
            <li class="cf post_order"><span class="label"><?php _e('Post order', 'tcd-w'); ?></span>
              <select name="dp_options[index_header_type2_post_order]">
              <option style="padding-right: 10px;" value="date" <?php selected('date', $options['index_header_type2_post_order']); ?>><?php _e('Post date', 'tcd-w'); ?></option>
              <option style="padding-right: 10px;" value="rand" <?php selected('rand', $options['index_header_type2_post_order']); ?>><?php _e('Random', 'tcd-w'); ?></option>
              </select>
            </li>
            <li class="cf"><span class="label"><?php _e('Number of post to display', 'tcd-w');  ?></span>
              <select name="dp_options[index_header_type2_post_num]">
              <?php for($i=1; $i<= 5; $i++): ?>
              <option style="padding-right: 10px;" value="<?php echo esc_attr($i); ?>" <?php selected( $options['index_header_type2_post_num'], $i ); ?>><?php echo esc_html($i); ?></option>
              <?php endfor; ?>
              </select>
            </li>
            <li class="cf"><span class="label"><?php _e('Font type of title', 'tcd-w');  ?></span>
              <select name="dp_options[index_header_type2_title_font_type]">
              <?php foreach ( $font_type_options as $option ) { ?>
              <option style="padding-right: 10px;" value="<?php echo esc_attr($option['value']); ?>" <?php selected( $options['index_header_type2_title_font_type'], $option['value'] ); ?>><?php echo $option['label']; ?></option>
              <?php } ?>
              </select>
            </li>
            <li class="cf"><span class="label"><?php _e('Font size of title', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[index_header_type2_title_font_size]" value="<?php esc_attr_e( $options['index_header_type2_title_font_size'] ); ?>" /><span>px</span></li>
            <li class="cf"><span class="label"><?php _e('Font size of title (mobile)', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[index_header_type2_title_font_size_mobile]" value="<?php esc_attr_e( $options['index_header_type2_title_font_size_mobile'] ); ?>" /><span>px</span></li>
            <li class="cf"><span class="label"><?php _e('Display date', 'tcd-w');  ?></span><input name="dp_options[index_header_type2_show_date]" type="checkbox" value="1" <?php checked( '1', $options['index_header_type2_show_date'] ); ?> /></li>
            <li class="cf"><span class="label"><?php _e('Display category', 'tcd-w');  ?></span><input name="dp_options[index_header_type2_show_category]" type="checkbox" value="1" <?php checked( '1', $options['index_header_type2_show_category'] ); ?> /></li>
          </ul>
     ...
     <div class="index_slider_type3_option" style="<?php if($options['index_slider_type'] == 'type3') { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
         ...
         <div class="sub_box cf" style="margin-top:20px;">
          ...
          <div class="sub_box_content">
           ...
           <div class="theme_option_message2">
            ...
            <p><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-w'), '1130', '430'); ?></p>
           </div>
           <div class="image_box cf">
           ...
           <div style="<?php if($value['use_overlay'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
            <ul class="option_list" style="border-top:1px dotted #ccc; padding-top:12px;">
             <li class="cf"><span class="label"><?php _e('Color of overlay', 'tcd-w'); ?></span><input type="text" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][overlay_color]" value="<?php echo esc_attr( $value['overlay_color'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
             <li class="cf">
              <span class="label"><?php _e('Transparency of overlay', 'tcd-w'); ?></span><input class="hankaku index_slider_overlay_opacity<?php echo esc_attr( $key ); ?>" style="width:70px;" type="number" max="1" min="0" step="0.1" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][overlay_opacity]" value="<?php echo esc_attr( $value['overlay_opacity'] ); ?>" />
              <div class="theme_option_message2" style="clear:both; margin:7px 0 0 0;">
          ...
          <div class="sub_box_content">
           ...
           <ul class="option_list">
            <li class="cf"><span class="label"><?php _e('Content placement', 'tcd-w');  ?></span>
              <select name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][contents_place]">
            ...
            <li class="cf"><span class="label"><?php _e('Font color', 'tcd-w'); ?></span><input type="text" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][contents_color]" value="<?php echo esc_attr( $value['contents_color'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
            <li class="cf"><span class="label"><?php _e('Font color (mobile)', 'tcd-w'); ?></span><input type="text" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][mobile_contents_color]" value="<?php echo esc_attr( $value['mobile_contents_color'] ); ?>" data-default-color="#FFFFFF" class="c-color-picker"></li>
           </ul>
           ...
           <ul class="option_list">
            <li class="cf"><span class="label"><?php _e('Catchphrase', 'tcd-w');  ?></span>
              <textarea class="full_width" cols="50" rows="2" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][catch]"><?php echo esc_textarea(  $value['catch'] ); ?></textarea>
            </li>
           ...
           <ul class="option_list">
            <li class="cf"><span class="label"><?php _e('Description', 'tcd-w');  ?></span>
             <textarea class="full_width" cols="50" rows="3" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][desc]"><?php echo esc_textarea(  $value['desc'] ); ?></textarea>
            </li>
            ...
            <li class="cf"><span class="label"><?php _e('Font size (mobile)', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][desc_font_size_mobile]" value="<?php echo esc_attr( $value['desc_font_size_mobile'] ); ?>" /><span>px</span></li>
            <div class="theme_option_message2">
             <p><?php _e('Leave this field blank if you want to display same description in mobile device.', 'tcd-w'); ?></p>
            </div>
            <li class="cf"><span class="label"><?php _e('Description (mobile)', 'tcd-w');  ?></span>
             <textarea class="full_width" cols="50" rows="3" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][desc_mobile]"><?php echo esc_textarea(  $value['desc_mobile'] ); ?></textarea>
            </li>
           </ul>
           <?php // ボタン ----------------------- ?>
           <h4 class="theme_option_headline2"><?php _e('Button setting', 'tcd-w');  ?></h4>
           <p class="displayment_checkbox"><label><input name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][show_button]" type="checkbox" value="1" <?php checked( $value['show_button'], 1 ); ?>><?php _e( 'Display button', 'tcd-w' ); ?></label></p>
           <div class="button_option_area" style="<?php if($value['show_button'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
            <ul class="option_list button_option_area" style="border-top:1px dotted #ccc; padding-top:12px;">
             <li class="cf"><span class="label"><?php _e('label', 'tcd-w');  ?></span><input class="full_width" type="text" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][button_label]" value="<?php esc_attr_e( $value['button_label'] ); ?>" /></li>
             <li class="cf"><span class="label"><?php _e('URL', 'tcd-w');  ?></span><input class="full_width" type="text" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][button_url]" value="<?php esc_attr_e( $value['button_url'] ); ?>" /></li>
             ...
             <li class="cf"><span class="label"><?php _e('Button type', 'tcd-w');  ?></span>
              <select class="button_type_option" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][button_type]">
             ...
             <li class="cf"><span class="label"><?php _e('Button shape', 'tcd-w');  ?></span>
              <select name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][button_shape]">
             ...
             <li class="cf button_type1_option">
              <span class="label"><?php _e('Background color', 'tcd-w'); ?></span>
              <div class="use_main_color">
               <input type="text" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][button_bg_color]" value="<?php echo esc_attr( $value['button_bg_color'] ); ?>" data-default-color="#000000" class="c-color-picker">
              </div>
              <div class="use_main_color_checkbox">
               <label>
                <input name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][button_bg_color_use_main]" type="checkbox" value="1" <?php checked( $value['button_bg_color_use_main'], 1 ); ?>>
                <span><?php _e('Apply key color1', 'tcd-w'); ?></span>
               </label>
              </div>
             </li>
             <li class="cf non_button_type1_option"><span class="label"><?php _e('Border color', 'tcd-w'); ?></span><input type="text" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][button_border_color]" value="<?php echo esc_attr( $value['button_border_color'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></li>
             ...
             <li class="cf"><span class="label"><?php _e('Font color of on mouseover', 'tcd-w'); ?></span><input type="text" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][button_font_color_hover]" value="<?php echo esc_attr( $value['button_font_color_hover'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></li>
             <li class="cf">
              <span class="label"><?php _e('Background color on mouseover', 'tcd-w'); ?></span>
              <div class="use_main_color">
               <input type="text" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][button_bg_color_hover]" value="<?php echo esc_attr( $value['button_bg_color_hover'] ); ?>" data-default-color="#444444" class="c-color-picker">
              </div>
              <div class="use_main_color_checkbox">
               <label>
                <input name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][button_bg_color_hover_use_sub]" type="checkbox" value="1" <?php checked( $value['button_bg_color_hover_use_sub'], 1 ); ?>>
                <span><?php _e('Apply key color2', 'tcd-w'); ?></span>
               </label>
              </div>
             </li>
             <li class="cf non_button_type1_option">
              ...
              <div class="use_main_color">
               <input type="text" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][button_border_color_hover]" value="<?php echo esc_attr( $value['button_border_color_hover'] ); ?>" data-default-color="#444444" class="c-color-picker">
              </div>
              <div class="use_main_color_checkbox">
               <label>
                <input name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][button_border_color_hover_use_sub]" type="checkbox" value="1" <?php checked( $value['button_border_color_hover_use_sub'], 1 ); ?>>
                <span><?php _e('Apply key color2', 'tcd-w'); ?></span>
               </label>
              </div>
             </li>
             <li class="cf non_button_type1_option">
              <span class="label"><?php _e('Transparency of border on mouseover', 'tcd-w'); ?></span><input class="hankaku" style="width:70px;" type="number" max="1" min="0" step="0.1" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][button_border_color_hover_opacity]" value="<?php echo esc_attr( $value['button_border_color_hover_opacity'] ); ?>" />
              <div class="theme_option_message2" style="clear:both; margin:7px 0 0 0;">
               <p><?php _e('Please specify the number of 0.1 from 0.9. Overlay color will be more transparent as the number is small.', 'tcd-w');  ?></p>
              </div>
             </li>
     ...
     <?php // ヘッダーコンテンツ 共通設定 --------------------------------------- ?>
     <div class="index_slider_common_option" style="<?php if($options['index_slider_type'] == 'type1') { echo 'display:none;'; } else { echo 'display:block;'; }; ?>">
       ...
       <select class="index_slider_time" name="dp_options[index_slider_time]">
        <?php
             ...
             foreach ( $time_options as $option ):
               if( $i >= 3 && $i <= 15 ){
        ?>
        <option <?php if($i < 5){ echo 'class="no_animation"'; }; ?>style="padding-right: 10px;" value="<?php echo esc_attr( $option['value'] ); ?>" <?php selected( $options['index_slider_time'], $option['value'] ); ?>><?php echo esc_html($option['label']); ?></option>
        <?php
               }
               $i++;
            endforeach;
   ...
   <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <p class="displayment_checkbox"><label><input name="dp_options[show_index_box_content]" type="checkbox" value="1" <?php checked( $options['show_index_box_content'], 1 ); ?>><?php _e( 'Display box contents', 'tcd-w' ); ?></label></p>
     <div style="<?php if($options['show_index_box_content'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">

     <h4 class="theme_option_headline2"><?php _e('Common setting', 'tcd-w');  ?></h4>
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Font size of title', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[index_box_content_font_size]" value="<?php esc_attr_e( $options['index_box_content_font_size'] ); ?>" /><span>px</span></li>
     </ul>
    ...
    ?>
     <div class="sub_box cf">
      ...
      <div class="sub_box_content">
          ...
          <ul class="option_list">
            <li class="cf"><span class="label"><?php _e('Catchphrase', 'tcd-w'); ?></span><textarea class="full_width" cols="50" rows="2" name="dp_options[index_box_content_headline<?php echo $i ?>]"><?php echo esc_textarea(  $options['index_box_content_headline'.$i] ); ?></textarea></li>
            <li class="cf"><span class="label"><?php _e('Description', 'tcd-w'); ?></span><textarea class="full_width" cols="50" rows="3" name="dp_options[index_box_content_desc<?php echo $i ?>]"><?php echo esc_textarea(  $options['index_box_content_desc'.$i] ); ?></textarea></li>
            <li class="cf"><span class="label"><?php _e('URL', 'tcd-w'); ?></span><input class="full_width" type="text" name="dp_options[index_box_content_url<?php echo $i ?>]" value="<?php esc_attr_e( $options['index_box_content_url'.$i] ); ?>" style="max-width:25em;" /></li>
          </ul>

          <h4 class="theme_option_headline2"><?php _e( 'Icon type', 'tcd-w' ); ?></h4>
          <ul class="design_radio_button">
            <li class="icon_type1_button">
              <input type="radio" id="icon_type1_<?php echo $i ?>" name="dp_options[index_box_content_icon_type<?php echo $i ?>]" value="type1" <?php checked( $options['index_box_content_icon_type'.$i], 'type1' ); ?> />
              <label class="icon_type1_button<?php echo $i ?>" for="icon_type1_<?php echo $i ?>"><?php _e( 'Display the image', 'tcd-w' ); ?></label>
            </li>
            <li class="icon_type1_button">
              <input type="radio" id="icon_type2_<?php echo $i ?>" name="dp_options[index_box_content_icon_type<?php echo $i ?>]" value="type2" <?php checked( $options['index_box_content_icon_type'.$i], 'type2' ); ?> />
              <label class="icon_type2_button<?php echo $i ?>" for="icon_type2_<?php echo $i ?>"><?php _e( 'Use icon fonts', 'tcd-w' ); ?></label>
            </li>
          </ul>

          <div class="icon_type1_wrap<?php echo $i ?>" style="<?php if($options['index_box_content_icon_type'.$i] == 'type1') { echo 'display:block'; } else { echo 'display:none;'; }; ?>">
          ...
          <p><label><input name="dp_options[index_box_content_image_retina<?php echo $i ?>]" type="checkbox" value="1" <?php checked( '1', $options['index_box_content_image_retina'.$i] ); ?> /> <?php _e('Use retina display logo image', 'tcd-w');  ?></label></p>

          </div>

          <div class="icon_type2_wrap<?php echo $i ?>" style="<?php if($options['index_box_content_icon_type'.$i] == 'type2') { echo 'display:block'; } else { echo 'display:none;'; }; ?>">

          <ul class="option_list">
            <li class="cf" style="padding-top:8px; border-top: 1px dotted #ddd;"><span class="label"><?php _e('Icon color', 'tcd-w'); ?></span><input type="text" name="dp_options[index_box_content_icon_color<?php echo $i ?>]" value="<?php echo esc_attr( $options['index_box_content_icon_color'.$i] ); ?>" data-default-color="#FFFFFF" class="c-color-picker"></li>
            <li class="cf"><span class="label"><?php _e('Icon size', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[index_box_content_icon_size<?php echo $i ?>]" value="<?php esc_attr_e( $options['index_box_content_icon_size'.$i] ); ?>" /><span>px</span></li>
            <li class="cf"><span class="label"><?php _e('Icon', 'tcd-w'); ?></span>
              ...
              <li><label><input type="radio" name="dp_options[index_box_content_icon<?php echo $i ?>]" value="<?php echo esc_attr($option['value']); ?>" <?php checked( $options['index_box_content_icon'.$i], $option['value'] ); ?>><span class="icon icon-<?php echo esc_attr($option['value']); ?>"></span></label></li>
              <?php endforeach; ?>
              </ul>
            </li>
          </ul>
  ...
  <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
      ...
      <p class="displayment_checkbox"><label><input name="dp_options[show_index_news]" type="checkbox" value="1" <?php checked( $options['show_index_news'], 1 ); ?>><?php _e( 'Display news ticker', 'tcd-w' ); ?></label></p>
      <div style="<?php if($options['show_index_news'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
        <h4 class="theme_option_headline2"><?php _e('Basic setting', 'tcd-w');  ?></h4>
        <ul class="option_list">
          <li class="cf"><span class="label"><?php _e('Post type', 'tcd-w'); ?></span>
            <select name="dp_options[index_news_post_type]">
              <option style="padding-right: 10px;" value="news" <?php selected( $options['index_news_post_type'], 'news' ); ?>><?php echo esc_html($news_label); ?></option>
              <option style="padding-right: 10px;" value="blog" <?php selected( $options['index_news_post_type'], 'blog' ); ?>><?php echo esc_html($blog_label); ?></option>
            </select>
          </li>
          <li class="cf"><span class="label"><?php _e('Display order of articles', 'tcd-w');  ?></span>
            <select name="dp_options[index_news_post_order]">
              <option value="date" <?php selected($options['index_news_post_order'], 'date'); ?>><?php _e('Date', 'tcd-w'); ?></option>
              <option value="rand" <?php selected($options['index_news_post_order'], 'rand'); ?>><?php _e('Random', 'tcd-w'); ?></option>
            </select>
          </li>
          <li class="cf"><span class="label"><?php _e('label', 'tcd-w'); ?></span>
            <input class="regular-text" type="text" name="dp_options[index_news_label]" value="<?php echo esc_attr($options['index_news_label']); ?>" />
          </li>
        </ul>
   ...
   <div class="contents_builder_wrap index_content_type1_option" style="<?php if($options['index_content_type'] == 'type1') { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
    ...
    <div class="contents_builder-clone hidden">
     ...
     <?php
          the_cb_content_setting('cb_cloneindex', 'category_list');
          the_cb_content_setting('cb_cloneindex', 'blog_carousel');
          the_cb_content_setting('cb_cloneindex', 'tag_cloud');
          the_cb_content_setting('cb_cloneindex', 'column_content');
...
function add_front_page_theme_options_validate( $input ) {
  ...
  $input['index_news_label'] = wp_filter_nohtml_kses( $input['index_news_label'] );

  // ボックスコンテンツ
  $input['show_index_box_content'] = ! empty( $input['show_index_box_content'] ) ? 1 : 0;
  $input['index_box_content_font_size'] = wp_filter_nohtml_kses( $input['index_box_content_font_size'] );
  for ( $i = 1; $i <= 2; $i++ ) {
    $input['index_box_content_headline'.$i] = wp_filter_nohtml_kses( $input['index_box_content_headline'.$i] );
    $input['index_box_content_icon_type'.$i] = wp_filter_nohtml_kses( $input['index_box_content_icon_type'.$i] );
    ...
    $input['index_box_content_image_retina'.$i] = ! empty( $input['index_box_content_image_retina'.$i] ) ? 1 : 0;
    if ( ! isset( $input['index_box_content_icon'.$i] ) )
    $input['index_box_content_icon'.$i] = null;
    if ( ! array_key_exists( $input['index_box_content_icon'.$i], $box_content_icon_options ) )
    $input['index_box_content_icon'.$i] = null;
    $input['index_box_content_icon_color'.$i] = sanitize_hex_color( $input['index_box_content_icon_color'.$i] );
    $input['index_box_content_icon_size'.$i] = wp_filter_nohtml_kses( $input['index_box_content_icon_size'.$i] );
  }
  ...
  // タイプ 1
  $input['index_header_type1_logo'] = wp_filter_nohtml_kses( $input['index_header_type1_logo'] );
  $input['index_header_type1_catch'] = wp_filter_nohtml_kses( $input['index_header_type1_catch'] );
  $input['index_header_type1_desc'] = wp_filter_nohtml_kses( $input['index_header_type1_desc'] );
  $input['index_header_type1_bg_color'] = wp_filter_nohtml_kses( $input['index_header_type1_bg_color'] );
  $input['index_header_type1_bg_color_use_sub'] = ! empty( $input['index_header_type1_bg_color_use_sub'] ) ? 1 : 0;
  $input['index_header_type1_bg_opacity'] = wp_filter_nohtml_kses( $input['index_header_type1_bg_opacity'] );

  $input['index_header_type1_use_search_form'] = ! empty( $input['index_header_type1_use_search_form'] ) ? 1 : 0;
  $input['index_header_type1_search_form_bg_color'] = wp_filter_nohtml_kses( $input['index_header_type1_search_form_bg_color'] );
  $input['index_header_type1_search_form_bg_color_use_main'] = ! empty( $input['index_header_type1_search_form_bg_color_use_main'] ) ? 1 : 0;
  $input['index_header_type1_search_form_bg_opacity'] = wp_filter_nohtml_kses( $input['index_header_type1_search_form_bg_opacity'] );

  $input['index_header_type1_bg_image'] = wp_filter_nohtml_kses( $input['index_header_type1_bg_image'] );
  $input['index_header_type1_bg_image_mobile'] = wp_filter_nohtml_kses( $input['index_header_type1_bg_image_mobile'] );

  // タイプ2
  $input['index_header_type2_post_type'] = wp_filter_nohtml_kses( $input['index_header_type2_post_type'] );
  $input['index_header_type2_post_order'] = wp_filter_nohtml_kses( $input['index_header_type2_post_order'] );
  $input['index_header_type2_post_num'] = wp_filter_nohtml_kses( $input['index_header_type2_post_num'] );
  $input['index_header_type2_show_date'] = ! empty( $input['index_header_type2_show_date'] ) ? 1 : 0;
  $input['index_header_type2_show_category'] = ! empty( $input['index_header_type2_show_category'] ) ? 1 : 0;
  $input['index_header_type2_title_font_size'] = wp_filter_nohtml_kses( $input['index_header_type2_title_font_size'] );
  $input['index_header_type2_title_font_size_mobile'] = wp_filter_nohtml_kses( $input['index_header_type2_title_font_size_mobile'] );
  if ( ! isset( $value['index_header_type2_title_font_type'] ) )
    $value['index_header_type2_title_font_type'] = null;
  if ( ! array_key_exists( $value['index_header_type2_title_font_type'], $font_type_options ) )
    $value['index_header_type2_title_font_type'] = null;
  ...
  if ( isset( $input['index_slider'] ) && is_array( $input['index_slider'] ) ) {
    foreach ( $input['index_slider'] as $key => $value ) {
      $index_slider[] = array(
        ...
        'contents_place' => isset( $input['index_slider'][$key]['contents_place'] ) ? wp_filter_nohtml_kses( $input['index_slider'][$key]['contents_place'] ) : 'type1',
        'contents_color' => isset( $input['index_slider'][$key]['contents_color'] ) ? wp_filter_nohtml_kses( $input['index_slider'][$key]['contents_color'] ) : '#000000',
        'mobile_contents_color' => isset( $input['index_slider'][$key]['mobile_contents_color'] ) ? wp_filter_nohtml_kses( $input['index_slider'][$key]['mobile_contents_color'] ) : '#FFFFFF',
        ...
        'button_type' => isset( $input['index_slider'][$key]['button_type'] ) ? wp_filter_nohtml_kses( $input['index_slider'][$key]['button_type'] ) : 'type1',
        'button_shape' => isset( $input['index_slider'][$key]['button_shape'] ) ? wp_filter_nohtml_kses( $input['index_slider'][$key]['button_shape'] ) : 'type1',
        ...
        'button_bg_color' => isset( $input['index_slider'][$key]['button_bg_color'] ) ? wp_filter_nohtml_kses( $input['index_slider'][$key]['button_bg_color'] ) : '#00729f',
        'button_bg_color_use_main' => ! empty( $input['index_slider'][$key]['button_bg_color_use_main'] ) ? 1 : 0,
        'button_bg_color_hover' => isset( $input['index_slider'][$key]['button_bg_color_hover'] ) ? wp_filter_nohtml_kses( $input['index_slider'][$key]['button_bg_color_hover'] ) : '#00466d',
        'button_bg_color_hover_use_sub' => ! empty( $input['index_slider'][$key]['button_bg_color_hover_use_sub'] ) ? 1 : 0,
        ...
        'button_border_color_hover' => isset( $input['index_slider'][$key]['button_border_color_hover'] ) ? wp_filter_nohtml_kses( $input['index_slider'][$key]['button_border_color_hover'] ) : '#00466d',
        'button_border_color_hover_opacity' => isset( $input['index_slider'][$key]['button_border_color_hover_opacity'] ) ? wp_filter_nohtml_kses( $input['index_slider'][$key]['button_border_color_hover_opacity'] ) : '1',
        'button_border_color_hover_use_sub' => ! empty( $input['index_slider'][$key]['button_border_color_hover_use_sub'] ) ? 1 : 0,
...
<?php
     ...
     if ($cb_content_select == 'category_list') {
       ...
       if (!isset($value['title_font_size'])) { $value['title_font_size'] = '28'; }
       if (!isset($value['title_font_size_mobile'])) { $value['title_font_size_mobile'] = '20'; }
...
?>
  ...
  <div class="cb_content">
   ...
   <p><label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_content]" type="checkbox" value="1" <?php checked( $value['show_content'], 1 ); ?>> <?php _e('Display category list', 'tcd-w'); ?></label></p>
   <ul class="option_list" style="border-top:1px dotted #ccc; padding-top:12px;">
    <li class="cf"><span class="label"><?php _e('Background color', 'tcd-w');  ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][content_bg_color]" value="<?php echo esc_attr( $value['content_bg_color'] ); ?>" data-default-color="#FFFFFF" class="c-color-picker"></li>
   </ul>
   ...
   <h4 class="theme_option_headline2"><?php _e('Catchphrase', 'tcd-w');  ?></h4>
   <textarea class="full_width" cols="50" rows="3" name="dp_options[contents_builder][<?php echo $cb_index; ?>][catch]"><?php echo esc_textarea(  $value['catch'] ); ?></textarea>
   ...
   <div class="sub_box cf">
    ...
    <div class="sub_box_content">
     ...
     <ul class="category_check_list">
      ...
      <li>
        <label>
          <input name="dp_options[contents_builder][<?php echo $cb_index; ?>][category<?php echo $cat_id; ?>]" type="checkbox" value="1" <?php checked( $value['category'.$cat_id], 1 ); ?> />
...
?>
  ...
  <div class="cb_content">
   ...
   <p><label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_content]" type="checkbox" value="1" <?php checked( $value['show_content'], 1 ); ?>> <?php printf(__('Display %s carousel', 'tcd-w'), $blog_label); ?></label></p>
   <ul class="option_list" style="border-top:1px dotted #ccc; padding-top:12px;">
    <li class="cf"><span class="label"><?php _e('Background color', 'tcd-w');  ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][content_bg_color]" value="<?php echo esc_attr( $value['content_bg_color'] ); ?>" data-default-color="#F4F4F4" class="c-color-picker"></li>
   </ul>
   ...
   <ul class="option_list">
    <li class="cf"><span class="label"><?php _e('Post type', 'tcd-w'); ?></span>
      <select name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_type]">
...
<?php
     // タグクラウド　-------------------------------------------------------------
       ...
       if (!isset($value['title_font_size_mobile'])) { $value['title_font_size_mobile'] = '12'; }
...
?>
  ...
  <div class="cb_content">
   ...
   <p><label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_content]" type="checkbox" value="1" <?php checked( $value['show_content'], 1 ); ?>> <?php _e('Display tag cloud', 'tcd-w'); ?></label></p>
   <ul class="option_list" style="border-top:1px dotted #ccc; padding-top:12px;">
    <li class="cf"><span class="label"><?php _e('Background color', 'tcd-w');  ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][content_bg_color]" value="<?php echo esc_attr( $value['content_bg_color'] ); ?>" data-default-color="#FFFFFF" class="c-color-picker"></li>
   </ul>
   ...
   <div class="sub_box cf">
    ...
    <ul class="tag_check_list">
      ...
      <li>
        <label>
          <input name="dp_options[contents_builder][<?php echo $cb_index; ?>][tag<?php echo $tag_id; ?>]" type="checkbox" value="1" <?php checked( $value['tag'.$tag_id], 1 ); ?> />
   ...
   <h4 class="theme_option_headline2"><?php _e('Basic setting', 'tcd-w');  ?></h4>
   <ul class="option_list">
    <li class="cf"><span class="label"><?php _e('Font size of tags', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][title_font_size]" value="<?php esc_attr_e( $value['title_font_size'] ); ?>" /><span>px</span></li>
    <li class="cf"><span class="label"><?php _e('Font size of tags (mobile)', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][title_font_size_mobile]" value="<?php esc_attr_e( $value['title_font_size_mobile'] ); ?>" /><span>px</span></li>
    <li class="cf"><span class="label"><?php _e('Background color', 'tcd-w'); ?></span>
      <div class="use_main_color">
	      <input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][bg_color]" value="<?php echo esc_attr( $value['bg_color'] ); ?>" data-default-color="#003046" class="c-color-picker">
      </div>
      <div class="use_main_color_checkbox">
	      <label>
	          <input name="dp_options[contents_builder][<?php echo $cb_index; ?>][bg_color_use_sub]" type="checkbox" value="1" <?php checked( $value['bg_color_use_sub'], 1 ); ?>>
	        <span><?php _e('Apply key color2', 'tcd-w'); ?></span>
        </label>
      </div>
    </li>
    <li class="cf"><span class="label"><?php _e('Background color on hover', 'tcd-w'); ?></span>
      <div class="use_main_color">
	      <input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][hover_bg_color]" value="<?php echo esc_attr( $value['hover_bg_color'] ); ?>" data-default-color="#0093cb" class="c-color-picker">
      </div>
      <div class="use_main_color_checkbox">
	      <label>
	          <input name="dp_options[contents_builder][<?php echo $cb_index; ?>][hover_bg_color_use_main]" type="checkbox" value="1" <?php checked( $value['hover_bg_color_use_main'], 1 ); ?>>
	        <span><?php _e('Apply key color1', 'tcd-w'); ?></span>
        </label>
      </div>
    </li>
...
<?php
     // 2カラムコンテンツ　-------------------------------------------------------------
       ...
       if (!isset($value['item_title_font_size'])) { $value['item_title_font_size'] = '22'; }
       if (!isset($value['item_title_font_size_mobile'])) { $value['item_title_font_size_mobile'] = '20'; }
...
?>
  ...
  <div class="cb_content">
   ...
   <p><label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_content]" type="checkbox" value="1" <?php checked( $value['show_content'], 1 ); ?>> <?php _e('Display 2 column content', 'tcd-w'); ?></label></p>
   <ul class="option_list" style="border-top:1px dotted #ccc; padding-top:12px;">
    <li class="cf"><span class="label"><?php _e('Background color', 'tcd-w');  ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][content_bg_color]" value="<?php echo esc_attr( $value['content_bg_color'] ); ?>" data-default-color="#F4F4F4" class="c-color-picker"></li>
   </ul>
   ...
   <div class="sub_box cf">
    <h3 class="theme_option_subbox_headline"><?php echo __('2 column content setting', 'tcd-w'); ?></h3>
    <div class="sub_box_content">
    ...
    <div class="repeater sortable" data-delete-confirm="<?php _e( 'Delete?', 'tcd-w' ); ?>">
     ...
     <div class="sub_box repeater-item repeater-item-<?php echo esc_attr( $repeater_key ); ?>">
      ...
      <div class="sub_box_content">
       ...
       <h4 class="theme_option_headline2"><?php _e( 'Basic setting', 'tcd-w' ); ?></h4>
       <ul class="option_list">
         <li class="cf"><span class="label"><?php _e('Title', 'tcd-w'); ?></span><input class="repeater-label full_width" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][title]" value="<?php echo esc_attr($repeater_value['title']); ?>" /></li>
         <li class="cf"><span class="label"><?php _e('Description', 'tcd-w'); ?></span><textarea class="full_width" cols="50" rows="3" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][desc]"><?php echo esc_textarea(  $repeater_value['desc'] ); ?></textarea></li>
         <li class="cf"><span class="label"><?php _e('URL', 'tcd-w'); ?></span><input class="full_width" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][url]" value="<?php esc_attr_e( $repeater_value['url'] ); ?>" style="max-width:25em;" /></li>
       </ul>
       ...
       <div class="image_box cf">
        <div class="cf cf_media_field hide-if-no-js tab_content_image_<?php echo $cb_index; ?>_image<?php echo esc_attr( $repeater_key ); ?>">
         <input type="hidden" value="<?php if ( $repeater_value['image'] ) echo esc_attr( $repeater_value['image'] ); ?>" id="tab_content_image_<?php echo $cb_index; ?>_image<?php echo esc_attr( $repeater_key ); ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][image]" class="cf_media_id">
     ...
     <div class="sub_box repeater-item repeater-item-<?php echo esc_attr( $repeater_key ); ?>">
      ...
      <div class="sub_box_content">
       ...
       <h4 class="theme_option_headline2"><?php _e( 'Basic setting', 'tcd-w' ); ?></h4>
       <ul class="option_list">
         <li class="cf"><span class="label"><?php _e('Title', 'tcd-w'); ?></span><input class="repeater-label full_width" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][title]" value="" /></li>
         <li class="cf"><span class="label"><?php _e('Description', 'tcd-w'); ?></span><textarea class="full_width" cols="50" rows="3" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][desc]"></textarea></li>
         <li class="cf"><span class="label"><?php _e('URL', 'tcd-w'); ?></span><input class="full_width" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][url]" value="" style="max-width:25em;" /></li>
       </ul>
       ...
       <div class="image_box cf">
        <div class="cf cf_media_field hide-if-no-js tab_content_image_<?php echo $cb_index; ?>_image<?php echo esc_attr( $repeater_key ); ?>">
         <input type="hidden" value="" id="tab_content_image_<?php echo $cb_index; ?>_image<?php echo esc_attr( $repeater_key ); ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_list][<?php echo esc_attr( $repeater_key ); ?>][image]" class="cf_media_id">
   ...
   <?php // リピーターここまで -------------------------- ?>
   <ul class="option_list" style="border-top:1px dotted #ccc; padding-top:12px;">
    <li class="cf"><span class="label"><?php _e('Font size of title', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_title_font_size]" value="<?php esc_attr_e( $value['item_title_font_size'] ); ?>" /><span>px</span></li>
    <li class="cf"><span class="label"><?php _e('Font size of title (mobile)', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_title_font_size_mobile]" value="<?php esc_attr_e( $value['item_title_font_size_mobile'] ); ?>" /><span>px</span></li>
   </ul>
