...
function add_quicktag_tab_label( $tab_labels ) {
	$tab_labels['quicktag'] = __( 'Quick tag & TOC', 'tcd-w' );
	return $tab_labels;
}
...
function add_quicktag_dp_default_options( $dp_default_options ) {
  ...
  $dp_default_options['qt_h2_font_size_mobile'] = '26';
  ...
  $dp_default_options['qt_h3_font_size_mobile'] = '22';
  ...
  $dp_default_options['qt_h4_font_size_mobile'] = '18';
  ...
  $dp_default_options['qt_h5_font_size_mobile'] = '14';
  ...
  // 目次
  $dp_default_options['toc_title'] = __( 'Table of Contents', 'tcd-w' );

  $dp_default_options['active_toc_post_type_post'] = 1;
  $dp_default_options['active_toc_post_type_page'] = 1;
  $dp_default_options['active_toc_post_type_news'] = 1;
  $dp_default_options['active_toc_post_type_blog'] = 1;

  $dp_default_options['active_toc_heading_num'] = '2';
  $dp_default_options['active_toc_heading_type'] = '2-3';
  $dp_default_options['toc_title_color'] = '#0093cb';
  $dp_default_options['toc_title_color_use_main'] = 1;
  $dp_default_options['use_toc_scroll_animation'] = 1;
...
<div id="tab-content-quicktag" class="tab-content">
   ...
   <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <div class="sub_box cf">
      ...
      <div class="sub_box_content heading<?php echo $i; ?>">
       ...
       <ul class="option_list">
        ...
        <li class="cf"><span class="label"><?php _e('Font size (mobile)', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[qt_h<?php echo $i; ?>_font_size_mobile]" value="<?php esc_attr_e( $options['qt_h'. $i .'_font_size_mobile'] ); ?>"/><span>px</span></li>
   ...
   <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <div class="sub_box cf">
      <h3 class="theme_option_subbox_headline"><?php echo __( 'Basic button settings', 'tcd-w' ); ?></h3>
      <div class="sub_box_content">
       <div class="theme_option_message2" style="clear:both; margin:20px 0 0 0;">
        <p><?php _e('Please set the option from basic setting menu button option section.', 'tcd-w');  ?></p>
       </div>
       <ul class="button_list cf">
        <li><a class="close_sub_box button-ml" href="#"><?php echo __( 'Close', 'tcd-w' ); ?></a></li>
       </ul>
     ...
     <div class="sub_box cf">
      ...
      <div class="sub_box_content">
       ...
       <ul class="option_list button_option_area">
        ...
        <li class="cf button_animation_option_type1 hide_bg_color"><span class="label"><?php _e('Background color', 'tcd-w'); ?></span><input type="text" name="dp_options[qt_custom_button_bg_color<?php echo $i; ?>]" value="<?php echo esc_attr( $options['qt_custom_button_bg_color' . $i] ); ?>" data-default-color="<?php echo esc_attr( $dp_default_options['qt_custom_button_bg_color' . $i] ); ?>" class="c-color-picker"></li>
        ...
        <li class="cf"><span class="label"><?php _e('Hover effect', 'tcd-w');  ?></span>
         <select class="button_animation_option qtag_button_hover_option" name="dp_options[qt_custom_button_animation_type<?php echo $i; ?>]">
   ...
   <?php // 目次 --------------------------------------------- ?>
   <div class="theme_option_field cf theme_option_field_ac">
    <h3 class="theme_option_headline"><?php _e('Table of Contents setting', 'tcd-w');  ?></h3>
    <div class="theme_option_field_ac_content">
     <div class="theme_option_message2">
       <p><?php _e( 'The contents registered here will be applied to all pages displaying the table of contents and to the original <a href="./widgets.php">Table of Contents (tcd ver)</a> widget.', 'tcd-w' ); ?></br>
          <?php _e( 'The title of the table of contents can also be set individually from the editing screen of each article.', 'tcd-w' ); ?></p>
     </div>

       <h4 class="theme_option_headline2"><?php _e( 'Page to display the table of contents', 'tcd-w' ); ?></h4>
       <div class="theme_option_message2">
         <p><?php _e( 'Automatically generates a table of contents on the page of the checked post types.', 'tcd-w' ); ?></br>
            <?php _e( 'The display location is before the first h2. If there are no h2 tags, the table of contents will not be displayed.', 'tcd-w' ); ?></p>
       </div>
       <ul class="option_list">
          <li class="cf"><span class="label"><?php _e('Post', 'tcd-w');  ?></span><input name="dp_options[active_toc_post_type_post]" type="checkbox" value="1" <?php checked( '1', $options['active_toc_post_type_post'] ); ?> /></li>
          <li class="cf"><span class="label"><?php _e('Page', 'tcd-w');  ?></span><input name="dp_options[active_toc_post_type_page]" type="checkbox" value="1" <?php checked( '1', $options['active_toc_post_type_page'] ); ?> /></li>
          <li class="cf"><span class="label"><?php echo $news_label; ?></span><input name="dp_options[active_toc_post_type_news]" type="checkbox" value="1" <?php checked( '1', $options['active_toc_post_type_news'] ); ?> /></li>
          <li class="cf"><span class="label"><?php echo $blog_label; ?></span><input name="dp_options[active_toc_post_type_blog]" type="checkbox" value="1" <?php checked( '1', $options['active_toc_post_type_blog'] ); ?> /></li>
       </ul>

       <h4 class="theme_option_headline2"><?php _e( 'Basic setting', 'tcd-w' ); ?></h4>
       <ul class="option_list">
          <li class="cf"><span class="label"><?php _e('Created when there are more than X number of headings.', 'tcd-w');  ?></span>
          ...
          <li class="cf"><span class="label"><?php _e('Target heading', 'tcd-w'); ?></span>
            <select class="index_tab_post_list_type" name="dp_options[active_toc_heading_type]">
              <option style="padding-right: 10px;" value="2" <?php selected( $options['active_toc_heading_type'], '2' ); ?>><?php _e('h2のみ', 'tcd-w'); ?></option>
              <option style="padding-right: 10px;" value="2-3" <?php selected( $options['active_toc_heading_type'], '2-3' ); ?>><?php _e('h2〜h3', 'tcd-w'); ?></option>
              <option style="padding-right: 10px;" value="2-4" <?php selected( $options['active_toc_heading_type'], '2-4' ); ?>><?php _e('h2〜h4', 'tcd-w'); ?></option>
              <option style="padding-right: 10px;" value="2-5" <?php selected( $options['active_toc_heading_type'], '2-5' ); ?>><?php _e('h2〜h5', 'tcd-w'); ?></option>
            </select>
          </li>
          <li class="cf"><span class="label"><?php _e('Title of the table of contents', 'tcd-w'); ?></span><input class="regular-text" type="text" name="dp_options[toc_title]" value="<?php echo esc_attr($options['toc_title']); ?>" /></li>
          <li class="cf"><span class="label"><?php _e('Color scheme of the table of contents', 'tcd-w'); ?></span>
            <div class="use_main_color">
              <input type="text" name="dp_options[toc_title_color]" value="<?php echo esc_attr( $options['toc_title_color'] ); ?>" data-default-color="#0093cb" class="c-color-picker">
            </div>
            <div class="use_main_color_checkbox">
            <label>
              <input name="dp_options[toc_title_color_use_main]" type="checkbox" value="1" <?php checked( $options['toc_title_color_use_main'], 1 ); ?>>
              <span><?php _e('Apply key color1', 'tcd-w'); ?></span>
            </label>
            </div>
          </li>
          <li class="cf"><span class="label"><?php _e('Use smooth scrolling', 'tcd-w');  ?></span><input name="dp_options[use_toc_scroll_animation]" type="checkbox" value="1" <?php checked( '1', $options['use_toc_scroll_animation'] ); ?> /></li>
          <li class="cf"><span class="label"><?php _e('Don\'t use theme styles', 'tcd-w');  ?></span><input name="dp_options[use_toc_theme_style]" type="checkbox" value="1" <?php checked( '1', $options['use_toc_theme_style'] ); ?> /></li>
       </ul>
...
function add_quicktag_theme_options_validate( $input ) {
  ...
  for ( $i = 2; $i <= 5; $i++ ) {
    ...
    $input['qt_h'.$i.'_font_size_mobile'] = wp_filter_nohtml_kses( $input['qt_h'.$i.'_font_size_mobile'] );
  ...
  $input['toc_title_color'] = sanitize_hex_color( $input['toc_title_color'] );
  $input['toc_title_color_use_main'] = ! empty( $input['toc_title_color_use_main'] ) ? 1 : 0;
  $input['active_toc_post_type_post'] = ! empty( $input['active_toc_post_type_post'] ) ? 1 : 0;
  $input['active_toc_post_type_page'] = ! empty( $input['active_toc_post_type_page'] ) ? 1 : 0;
  $input['active_toc_post_type_news'] = ! empty( $input['active_toc_post_type_news'] ) ? 1 : 0;
  $input['active_toc_post_type_blog'] = ! empty( $input['active_toc_post_type_blog'] ) ? 1 : 0;
  ...
  $input['use_toc_scroll_animation'] = ! empty( $input['use_toc_scroll_animation'] ) ? 1 : 0;
