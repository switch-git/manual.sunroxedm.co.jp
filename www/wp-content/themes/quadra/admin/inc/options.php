...
$load_icon_type = array(
 ...
 'type3' => array('value' => 'type3','label' => __( 'Dot circle', 'tcd-w' )),
...
$catch_animation_type_options = array(
  'type1' => array('value' => 'type1','label' => __( 'Animate all words from bottom to upward', 'tcd-w' )),
  'type2' => array('value' => 'type2','label' => __( 'Animate letter one by one', 'tcd-w' )),
);


// ボックスコンテンツのアイコン
global $box_content_icon_options;
$box_content_icon_options = array(
  'pencil' => array('value' => 'pencil'),
  'notifications' => array('value' => 'notifications'),
  'build' => array('value' => 'build'),
  'favorite' => array('value' => 'favorite'),
  'help' => array('value' => 'help'),
  'location' => array('value' => 'location'),
  'magnifying-glass' => array('value' => 'magnifying-glass'),
  'message' => array('value' => 'message'),
  'book' => array('value' => 'book'),
  'download' => array('value' => 'download'),
  'phone2' => array('value' => 'phone2'),
  'laptop' => array('value' => 'laptop'),
  'avn_blog' => array('value' => 'avn_blog'),
  'folder' => array('value' => 'folder'),
  'avn_headphones' => array('value' => 'avn_headphones'),
  'shopping_cart' => array('value' => 'shopping_cart'),
  'zm_camera' => array('value' => 'zm_camera'),
  'sphere' => array('value' => 'sphere'),
  'checkmark' => array('value' => 'checkmark'),
  'star' => array('value' => 'star'),
  'cog' => array('value' => 'cog'),
  'warning' => array('value' => 'warning'),
  'bar-chart' => array('value' => 'bar-chart'),
  'phone' => array('value' => 'phone'),
  'lightbulb' => array('value' => 'lightbulb'),
  'desktop' => array('value' => 'desktop'),
  'rocket' => array('value' => 'rocket'),
  'file-text' => array('value' => 'file-text'),
  'thumbs-up' => array('value' => 'thumbs-up'),
  'line-chart' => array('value' => 'line-chart'),
);
